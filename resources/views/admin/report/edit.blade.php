...
@section('content')
    ...
    <form action="{{ route('report_update', $report) }}" method="post" enctype="multipart/form-data" data-parsley-validate="" data-parsley-excluded="[disabled]">
       @csrf
        @method('put')
    ...
    <div class="form-group mt-3">
       ...
       <div class="form-group mt-3">
        ...
        <div class="form-group mt-3">
            ...
            <input type="number" name="total_jam" id="total_jam" class="form-control input-rounded" placeholder="Masukan Jumlah Jam" value="{{ $report->total_jam }}" step="0.01" required integer data-parsley-required-message="Eiitss Ini Kelupaan Isi Jumlah Jam">                  
            @error('total_jam')
            <div class="text-danger mt-2 d-block">{{ $message }}</div>
            @enderror                                  
        </div>
    ...
    <div class="form-group mt-3">
        ...
        <div class="form-check form-check-inline">
         ...
         <div class="form-check form-check-inline">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="gender_wanita" id="inlineRadio10" value="100" {{ ($report->gender_wanita=="100")? "checked" : "" }} data-parsley-trigger="change" required data-parsley-required-message="Diisi Dulu Persentase Jumlah Wanitanya">
